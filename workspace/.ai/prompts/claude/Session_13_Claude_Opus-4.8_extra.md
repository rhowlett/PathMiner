# Session 13 — Headless runner, jobs and factorization reuse
...
- **Parallel wave:** W10
- **Prerequisite sessions:** Session 07, Session 09, Session 12
...
Build GUI-independent orchestration with cancellable jobs, graph/factorization reuse, and model-selection metadata.
...
1. Work in a dedicated branch/worktree named `ai/session-13-claude-headless-runner`.
2. Start from the exact coordinator-approved commit containing all prerequisites: Session 07, Session 09, Session 12.
...
- pathminer/analysis/resistance.py
- pathminer/analysis/runner.py
- pathminer/analysis/jobs.py
...
- factorization cache keyed by effective model
...
- python3 -m pytest -q tests/test_runner.py tests/test_factorization_reuse.py tests/test_jobs.py
...
- `.ai/handoffs/Session_13_Claude.md`
- `.ai/handoffs/Session_13_Claude.json`
