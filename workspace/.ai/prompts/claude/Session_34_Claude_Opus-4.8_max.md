# Session 34 — Signal overlays, field-solver correlation and final gates
...
- **Parallel wave:** W24
- **Prerequisite sessions:** Session 31, Session 33
...
Deliver signal-return overlays and risk metrics, correlate representative structures, and close cross-capability confidence and release gates.
...
1. Work in a dedicated branch/worktree named `ai/session-34-claude-signal-release`.
2. Start from the exact coordinator-approved commit containing all prerequisites: Session 31, Session 33.
...
- pathminer/report/signal_return.py
- pathminer/ui/views/signal_return.py
- tests/correlation/signal/
- tests/integration/test_signal_return.py
...
- magnitude/phase/detour/transition overlays
- documented frequency/geometry error bounds
- Screening/Correlated/Signoff-capable labels
- closed equation, confidence, and capability gates
...
- python3 -m pytest -q
- python3 -m pathminer.cli selftest
...
- `.ai/handoffs/Session_34_Claude.md`
- `.ai/handoffs/Session_34_Claude.json`
