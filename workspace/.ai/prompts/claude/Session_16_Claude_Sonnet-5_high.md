# Session 16 — Application shell, Project destination and shared status
...
- **Parallel wave:** W8-C
- **Prerequisite sessions:** Session 09, Session 10
...
Build the new navigation shell, persistent project header, shared job bar, Project destination, and standard section behavior.
...
- BASE-003 (window/help naming slice)
...
1. Work in a dedicated branch/worktree named `ai/session-16-claude-ui-shell-project`.
2. Start from the exact coordinator-approved commit containing all prerequisites: Session 09, Session 10.
...
- pathminer/ui/app.py
- pathminer/ui/shell.py
- pathminer/ui/tabs/project.py
- pathminer/ui/widgets/project_header.py
- pathminer/ui/widgets/job_bar.py
- pathminer/ui/widgets/collapsible_section.py
- tests/ui/test_shell.py
- tests/ui/test_project.py
...
- shared job UI
- Project-owned board facts/profiles

## Verification

Run these commands when the named files exist, plus any narrower tests needed for changed code:

- python3 -m pytest -q tests/ui/test_shell.py tests/ui/test_project.py
...
- `.ai/handoffs/Session_16_Claude.md`
- `.ai/handoffs/Session_16_Claude.json`
