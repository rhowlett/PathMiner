# Session 15 — CLI, exit codes and CI examples
...
- **Parallel wave:** W11-A
- **Prerequisite sessions:** Session 13, Session 14
...
Expose saved headless workflows through stable subcommands and CI-safe exit codes.
...
1. Work in a dedicated branch/worktree named `ai/session-15-claude-cli-automation`.
2. Start from the exact coordinator-approved commit containing all prerequisites: Session 13, Session 14.
...
- stable exit-code enum
- schema-validation and audit CI examples
- PathMiner command naming
...
- `.ai/handoffs/Session_15_Claude.md`
- `.ai/handoffs/Session_15_Claude.json`
