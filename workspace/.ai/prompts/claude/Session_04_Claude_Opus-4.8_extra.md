# Session 04 — Geometry and numerical backend extraction
...
Extract pure geometry and dense/CG/optional-SciPy numerical backends while preserving numerical behavior.
...
1. Work in a dedicated branch/worktree named `ai/session-04-claude-geometry-solver`.
...
- backend-independent solver functions
- backend agreement vectors
- compiled-acceleration decision thresholds

## Verification

Run these commands when the named files exist, plus any narrower tests needed for changed code:

- python3 -m pytest -q tests/test_geometry.py tests/test_solver.py
...
- `.ai/handoffs/Session_04_Claude.md`
- `.ai/handoffs/Session_04_Claude.json`
