# Session 08 — Compatibility integration and single-file build
...
- **Parallel wave:** W5
- **Prerequisite sessions:** Session 03, Session 04, Session 07
...
Integrate extracted modules into the legacy entry point, close solver dispatch and modular self-tests, and preserve a generated single-file distribution.
...
1. Work in a dedicated branch/worktree named `ai/session-08-claude-compatibility-integration`.
2. Start from the exact coordinator-approved commit containing all prerequisites: Session 03, Session 04, Session 07.
...
- pathminer/__init__.py
- pathminer/core/__init__.py
...
- completed solver dispatcher
- aggregate module self-test
...
- `.ai/handoffs/Session_08_Claude.md`
- `.ai/handoffs/Session_08_Claude.json`
