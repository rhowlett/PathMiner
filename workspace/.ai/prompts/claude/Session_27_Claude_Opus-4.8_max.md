# Session 27 — Simultaneous multi-load solve and what-if
...
- **Parallel wave:** W19
- **Prerequisite sessions:** Session 25, Session 26
...
Solve simultaneous shared-copper operating scenarios and implement immutable scenario cloning and delta comparison.
...
1. Work in a dedicated branch/worktree named `ai/session-27-claude-multi-load-what-if`.
2. Start from the exact coordinator-approved commit containing all prerequisites: Session 25, Session 26.
...
- pathminer/analysis/power_system.py
- pathminer/analysis/scenario_compare.py
- pathminer/ui/widgets/result_compare.py (integration only)
- tests/test_power_system.py
...
- simultaneous nonlinear solve
- shared-edge currents and KCL
- traceable immutable variants
- exportable deltas
...
- python3 -m pytest -q tests/test_power_system.py tests/test_scenario_compare.py
...
- `.ai/handoffs/Session_27_Claude.md`
- `.ai/handoffs/Session_27_Claude.json`
