# Session 11 — Project storage, identifiers, provenance and atomic writes
...
- **Parallel wave:** W8-A
- **Prerequisite sessions:** Session 10
...
Implement the portable .pathminer layout, stable resolution data, provenance, atomic persistence, and version-control policy.
...
1. Work in a dedicated branch/worktree named `ai/session-11-claude-project-storage`.
2. Start from the exact coordinator-approved commit containing all prerequisites: Session 10.
...
- pathminer/storage/project.py
- pathminer/storage/json_store.py
- pathminer/storage/provenance.py
- tests/test_project_storage.py
- tests/test_atomic_write.py
- documents/adr/ADR-005.md
- documents/version_control_policy.md
...
- python3 -m pytest -q tests/test_project_storage.py tests/test_atomic_write.py
...
- `.ai/handoffs/Session_11_Claude.md`
- `.ai/handoffs/Session_11_Claude.json`
