...
Create an immutable and measurable v0.13 baseline before structural work begins.
...
- QA-004 (establish fixtures)
- QA-006 (record initial budgets)
...
1. Work in a dedicated branch/worktree named `ai/session-01-claude-baseline`.
2. Start from the exact coordinator-approved commit containing all prerequisites: None.
...
- baseline/
- tests/baseline/
- documents/compatibility_inventory.md
- documents/adr/ADR-001.md
- pyproject/test runner files only if needed for baseline execution
...
- immutable baseline identifier
- compatibility inventory
- golden fixtures with volatile fields normalized
- baseline test and performance report
...
- reference-board and power-bank acceptance runs when the boards are available
...
- `.ai/handoffs/Session_01_Claude.md`
- `.ai/handoffs/Session_01_Claude.json`
