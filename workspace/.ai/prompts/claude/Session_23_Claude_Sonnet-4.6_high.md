# Session 23 — Thin KiCad capture plugin
...
Build a modeless ordered path-capture plugin over the live BoardSource without duplicating analysis logic.
...
1. Work in a dedicated branch/worktree named `ai/session-23-claude-kicad-plugin`.
...
- pathminer/plugin/
- tests/plugin/
- documents/plugin_user_guide.md
...
- live BoardSource adapter
- modeless ordered capture
...
- `.ai/handoffs/Session_23_Claude.md`
- `.ai/handoffs/Session_23_Claude.json`
