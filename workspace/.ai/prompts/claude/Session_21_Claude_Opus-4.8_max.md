# Session 21 — Resistance v1 integration and release gate
...
- **Parallel wave:** W14
- **Prerequisite sessions:** Session 15, Session 18, Session 20
...
Integrate the refactor, close remaining naming/model-selection/verification work, and produce a releasable Resistance v1 candidate.
...
- QA-001 (resistance slice verified)
- QA-008 (resistance confidence slice)
- QA-009 (resistance gate slice)
...
1. Work in a dedicated branch/worktree named `ai/session-21-claude-resistance-v1`.
2. Start from the exact coordinator-approved commit containing all prerequisites: Session 15, Session 18, Session 20.
...
- integration-only shared exports/facades/registries
- tests/integration/
- tests/performance/
...
- end-to-end Resistance workflow
- all baseline and real-board regressions
- performance budgets
...
- `.ai/handoffs/Session_21_Claude.md`
- `.ai/handoffs/Session_21_Claude.json`
