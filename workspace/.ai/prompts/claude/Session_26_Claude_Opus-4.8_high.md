# Session 26 — Power-tree structure and investigation integration
...
- **Parallel wave:** W18
- **Prerequisite sessions:** Session 22, Session 25
...
Build the source/conversion/load/ground/component power-tree model and scoped Investigation representation.
...
1. Work in a dedicated branch/worktree named `ai/session-26-claude-power-tree`.
2. Start from the exact coordinator-approved commit containing all prerequisites: Session 22, Session 25.
...
- pathminer/models/power_tree.py
- pathminer/analysis/power_tree.py
- pathminer/ui/views/power_tree.py
- tests/test_power_tree.py
- tests/ui/test_power_tree.py
...
- python3 -m pytest -q tests/test_power_tree.py tests/ui/test_power_tree.py
...
- `.ai/handoffs/Session_26_Claude.md`
- `.ai/handoffs/Session_26_Claude.json`
