# Session 09 — Shared domain contracts
...
- **Parallel wave:** W6
- **Prerequisite sessions:** Session 08
...
Define the immutable/shared contracts used by storage, headless analysis, CLI, reports, and UI.
...
1. Work in a dedicated branch/worktree named `ai/session-09-claude-domain-contracts`.
2. Start from the exact coordinator-approved commit containing all prerequisites: Session 08.
...
- pathminer/models/project.py
- pathminer/models/selection.py
- pathminer/models/scenario.py
- pathminer/models/result.py
- pathminer/models/job.py
- tests/test_domain_contracts.py
- documents/adr/ADR-002.md
...
- ProjectContext, SelectionModel, AnalysisProfile, AnalysisScenario, AnalysisResult, Verdict, and JobState
- serialization-neutral invariants
- contract tests
...
- python3 -m pytest -q tests/test_domain_contracts.py
...
- `.ai/handoffs/Session_09_Claude.md`
- `.ai/handoffs/Session_09_Claude.json`
