# Session 02 — Package and CI skeleton
...
- **Parallel wave:** W1
- **Prerequisite sessions:** Session 01
...
Create the installable package shell and automated dependency-direction guard without moving production behavior.
...
1. Work in a dedicated branch/worktree named `ai/session-02-claude-package-skeleton`.
2. Start from the exact coordinator-approved commit containing all prerequisites: Session 01.
...
- aggregate local and CI test commands
...
- `.ai/handoffs/Session_02_Claude.md`
- `.ai/handoffs/Session_02_Claude.json`
