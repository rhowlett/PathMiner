# Session 10 — Schemas, defaults and migration
...
- **Parallel wave:** W7
- **Prerequisite sessions:** Session 09
...
Define versioned schemas, derive defaults from them, and migrate v0.13 selections without loss.
...
1. Work in a dedicated branch/worktree named `ai/session-10-claude-schemas-migration`.
2. Start from the exact coordinator-approved commit containing all prerequisites: Session 09.
...
- schema/
- pathminer/storage/schema.py
- pathminer/storage/migration.py
- tests/test_schema.py
- tests/test_migration.py
- documents/adr/ADR-004.md
...
- in-memory migration and explicit-write policy
- round-trip tests
...
- python3 -m pytest -q tests/test_schema.py tests/test_migration.py
...
- `.ai/handoffs/Session_10_Claude.md`
- `.ai/handoffs/Session_10_Claude.json`
